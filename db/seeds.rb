...
User.create(name:'mitsuwo', status_id:2, email: 'test1@test.com', password: 'testest', thumbnail: "thumbnails/#{rand(0..10)}.png")
User.create(name:'kazuo', status_id:2, email: 'test2@test.com', password: 'testest', thumbnail: "thumbnails/#{rand(0..10)}.png" )
User.create(name:'mituttu', status_id:2, email: 'test3@test.com', password: 'testest', thumbnail: "thumbnails/#{rand(0..10)}.png")
User.create(name:'migfd', status_id:2, email: 'test4@test.com', password: 'testest', thumbnail: "thumbnails/#{rand(0..10)}.png")
